...
func (c *inventoryClient) SetInv(ctx context.Context, in *GoodsInventoryInfo, opts ...grpc.CallOption) (*Empty, error) {
...
type InventoryServer interface {
	SetInv(context.Context, *GoodsInventoryInfo) (*Empty, error)
...
func (UnimplementedInventoryServer) SetInv(context.Context, *GoodsInventoryInfo) (*Empty, error) {
